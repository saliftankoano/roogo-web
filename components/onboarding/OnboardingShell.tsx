 ...
 * Adapted from the onboarding-cinematic template with Roogo's brand identity.
 */
export function OnboardingShell({
  ...
  return (
    <div className="fixed inset-0 bg-[#0f0c0a] flex flex-col items-center justify-center overflow-hidden">
      {/* Brand Glows */}
