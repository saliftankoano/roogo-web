...
export function OwnerBenefitsStep({ onNext }: OwnerBenefitsStepProps) {
  return (
    <div className="space-y-8 w-full max-w-lg">
      ...
      >
        <HouseIcon size={40} weight="fill" className="text-primary" />
      </motion.div>
      ...
      <div className="space-y-3">
        ...
        >
          Roogo vous offre les meilleurs outils pour gérer vos biens
          immobiliers.
        </motion.p>
      </div>
      ...
      >
        {[
          { text: "Publiez vos annonces en quelques minutes", icon: HouseIcon },
          { text: "Gérez les candidatures facilement", icon: ListChecksIcon },
          { text: "Suivez vos revenus locatifs", icon: ChartLineUpIcon },
        ].map((benefit, idx) => (
          <motion.div
            key={benefit.text}
            custom={idx}
