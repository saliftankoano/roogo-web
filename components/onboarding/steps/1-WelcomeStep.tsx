  ...
  return (
    <div className="space-y-8">
      ...
      <motion.div
        ...
        transition={{ delay: 0.24, duration: 0.26, ease: [0.22, 1, 0.36, 1] }}
      >
        <Button
          onClick={onNext}
          size="lg"
          variant="primary"
          className="px-8 rounded-xl font-medium text-lg h-14 shadow-lg shadow-primary/20 transition-all active:scale-[0.985]"
        >
          C&apos;est parti
        </Button>
      </motion.div>
