...
const failureMigration = readFileSync(
  new URL(
    "../supabase/migrations/070_payment_failure_notifications_executed.sql",
    import.meta.url,
  ),
  "utf8",
);
const propertyLockMigration = readFileSync(
  new URL(
    "../supabase/migrations/071_atomic_property_lock_payments_executed.sql",
    import.meta.url,
  ),
  "utf8",
);
...
const paymentMigrations = [
  "070_payment_failure_notifications_executed.sql",
  "071_atomic_property_lock_payments_executed.sql",
  "072_atomic_listing_payments_executed.sql",
];
...
async function beforePayments() {
  ...
  `);
  await db.exec(migration("026_notification_deliveries_executed.sql"));
  return db;
}
