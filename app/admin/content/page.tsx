  ...
  return (
    <div className="space-y-8 max-w-7xl mx-auto">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-neutral-500 font-medium mt-1">
            Publiez des articles, des guides et des actualités.
          </p>
        </div>
      ...
      <div className="flex border-b border-neutral-100 gap-8 overflow-x-auto no-scrollbar">
        {["Tous les articles", "Publiés", "Brouillons", "Corbeille"].map(
          (tab, i) => (
            <button
              key={tab}
              ...
              >
                <td className="px-8 py-6">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h4 className="text-sm font-bold text-neutral-900 leading-tight mb-1 group-hover:text-primary transition-colors">
                        {article.title}
                      </h4>
                ...
                <td className="px-8 py-6">
                  <span
                    className={`text-[10px] font-bold px-3 py-1.5 rounded-lg uppercase tracking-widest border
                    ${
      ...
      {articles.length === 0 && (
        <div className="text-center py-20 bg-white rounded-[40px] border border-neutral-100 shadow-sm">
          ...
          <p className="text-neutral-500 max-w-xs mx-auto font-medium">
            Commencez à publier du contenu pour vos utilisateurs.
          </p>
        </div>
      )}
    </div>
